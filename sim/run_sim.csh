...
if ($FLIST == 1) then
    ...
    set files = "-ntb_opts uvm-ieee-2020-2.0 +define+UVM_OBJECT_MUST_HAVE_CONSTRUCTOR+UVM_TIMEOUT=1000000 -file $filelist -timescale=1ns/1ps $coverage1 $assert1"
else
    set files = "-ntb_opts uvm-ieee-2020-2.0 +define+UVM_OBJECT_MUST_HAVE_CONSTRUCTOR+UVM_TIMEOUT=1000000 +incdir+$UVM_DESIGN $VCS_HOME/etc/uvm-ieee-2020-2.0/uvm_pkg.sv $ROOT/design/$MODULE_TB.$TYPE -timescale=1ns/1ps $coverage1 $assert1"
endif
